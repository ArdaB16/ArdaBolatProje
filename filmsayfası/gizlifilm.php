...
<div id="body2">
 ...
 <?php
    if(isset($_SESSION['username'])) {
    echo '<div style="position:relative;"><IFRAME SRC="https://sruby.xyz/embed-x9hhpe3mzbv6.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=700 HEIGHT=400 allowfullscreen style="position:absolute;top:0;left:0;width:700;height:400;"></IFRAME></div>';
...
<div id="yorum">
  ...
  ?>
<form action="../yorumkaydet/gizlifilmyorumkaydet.php" method="post">
  ...
  <?php
    ...
    $yorumlar = file_get_contents("../yorumlar/gizlifilmyorum.txt");
