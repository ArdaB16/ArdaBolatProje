...
<div id="body2">
 ...
 <?php
    if(isset($_SESSION['username'])) {
    echo '<p style="text-align: center;"><iframe src="../filmler/hababamaskerde.mp4" width="700" height="400" allowfullscreen=""></iframe></p>';
...
<div id="yorum">
  ...
  ?>
<form action="../yorumkaydet/hababamaskeryorumkaydet.php" method="post">
  ...
  $yorumlar = file_get_contents("../yorumlar/hababamaskeryorum.txt");
