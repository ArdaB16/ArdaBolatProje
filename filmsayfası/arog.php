...
<div id="body2">
 ...
 <?php
    if(isset($_SESSION['username'])) {
    echo '<p style="text-align: center;"><iframe src="../filmler/arog.mp4" width="700" height="400" allowfullscreen=""></iframe></p>';
...
<div id="yorum">
  ...
  ?>
<form action="../yorumkaydet/arogyorumkaydet.php" method="post">
  ...
  $yorumlar = file_get_contents("../yorumlar/arogyorum.txt");
  $username = $_SESSION['username'];
  $yorumlar = str_replace("{username}", $username, $yorumlar);
  echo $yorumlar;
} 
else {
    echo '<p style="color:white;">Yorum Yazmak İçin Üye Olunuz</p>';
echo'<br>';
$yorumlar = file_get_contents("../yorumlar/arogyorum.txt");
echo $yorumlar;
}
